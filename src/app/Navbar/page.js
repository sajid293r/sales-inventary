...
const Page = () => {
  ...
  return (
    // <nav className="bg-white shadow-sm w-[310px] md:w-full lg:w-full shadow-gray-600 px-4 py-2 flex items-center justify-between relative ">
     <nav className="fixed top-0 left-0 right-0 bg-white shadow-sm w-[310px] md:w-full lg:w-full shadow-gray-600 px-4 py-2 flex items-center justify-between z-50 ">
      {/* Logo */}
