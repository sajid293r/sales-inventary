...
const TableWithCheckboxes = () => {
  ...
  const options = ["Asia", "North America", "South America", "Europe", "Africa", "Oceania"];
  ...
  return (
    <div className="p-4 w-full   min-w-[640px]   md:min-w-[800px] lg:min-w-[1000px] xl:min-w-[1300px] 2xl:min-w-[1300px] 3xl:min-w-[1400px] 4xl:min-w-[1600px] mx-auto table-auto">
      ...
      <div className="border rounded-lg bg-white p-6 mb-6 shadow-sm">
        <h1 className="text-base sm:text-lg font-semibold text-gray-900">Template</h1>
        <input
          type="text"
          className="border border-gray-300 rounded-md px-3 py-1 mt-2 w-full sm:w-3/4 md:w-1/2 focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  <div className="flex justify-center items-center min-h-[100px] w-full mb-4">
    <Image src={layer} alt="Upload placeholder" className="h-16 w-auto" />
  </div>
            ...
            <form className="space-y-2">
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  className="text-blue-600 focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700 font-semibold">Date Created</span>
              </label>
              <label className="flex items-center gap-2 border-t border-gray-200 pt-2">
                <MdArrowUpward />
                <span className="text-sm text-gray-700 font-semibold">Ascending</span>
              </label>
              <label className="flex items-center gap-2">
                <MdArrowDownward />
                <span className="text-sm text-gray-700 font-semibold">Descending</span>
              </label>
            </form>
          </div>
        )}
              ...
              <div className="relative">
                ...
                {isOpen && (
                  <div className="continent-dropdown absolute w-full bg-white border border-gray-200 rounded-md mt-1 shadow-sm z-10">
                    {options.map((option) => (
                      <label key={option} className="flex items-center gap-2 p-2 hover:bg-gray-100">
                        <input
                          type="checkbox"
          ...
          {paginatedData.map((row) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-2 text-sm">
                ...
                <div>
                  <span className="font-semibold">Date Creation:</span> {row.dateCreation}
                </div>
                <div>
